...
{/* <Button> */}
  ...
  xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={`size-4 sm:size-6  hover:stroke-pink-500 ${fav?"fill-pink-500 stroke-pink-500 hover:stroke-white":"stroke-white"} z-10  stroke-2 absolute top-1 left-2 cursor-pointer`}>
