  ...
  return (
    <div className={`relative h-min`}>
      {marking && (
        <>
          <div
            className={`bg-gray-600 opacity-45 ${
              marking ? "" : ""
      ...
      <svg
        ...
        strokeWidth={1.5}
        stroke="currentColor"
        className={`size-4 sm:size-6  hover:stroke-pink-500 ${
          fav
            ? "fill-pink-500 stroke-pink-500 hover:stroke-white"
            : "stroke-white"
        } z-10  stroke-2 absolute top-1 left-2 cursor-pointer`}
      >
        <path
          strokeLinecap="round"
