...
export default function Side_Nav({dialog,setdialog,hov,sethov,mob,setmob}:any) {
  // const [hov, sethov] = useState(false)
  // const [mob, setmob] = useState(window.screen.width<640?true:false)
  // const [hov, sethov] = useState(mob?false:true)
  // useEffect(() => {
  //   function setwidth(){
  ...
  // console.log(window.screen.width)640
  // console.log(window.innerWidth)
  return (
    <div onMouseEnter={()=>{sethov(true)}} 
    onMouseLeave={()=>{sethov(false)}} 
  className={`${dialog && mob?"":"delay-75 translate-x-[-100%] sm:translate-x-0"} ${hov ?"w-36":mob?"w-36":"w-14"} transition-all space-y-4 sm:flex flex-col items-center bg-gray-900 h-full px-3 w py-4 `}>
