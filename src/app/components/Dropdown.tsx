          ...
          <Button className="w-4 p-3" variant="outline">
            <span>
              <svg
                ...
                strokeWidth={1.5}
                stroke="currentColor"
                className="size-4 sm:size-6 stroke-2 stroke-white"
              >
                <path
                  strokeLinecap="round"
        ...
        <DropdownMenuContent className={`${theme.dark_theme ? "dark" : ""}`}>
          <DropdownMenuGroup className="flex flex-col gap-1 items-center ">
            <DropdownMenuItem asChild className="text-sm ">
              <Dialog open={open} onOpenChange={setopen}>
                <DialogTrigger asChild className="w-full h-full py-2 ">
                  <Button
                    className="text-xs px-3 flex justify-start gap-2 w-full h-full"
                    type="button"
                    variant="outline"
                  >
                    <svg
                ...
                >
                  ...
                  <DialogFooter className="gap-4 sm:gap-1">
                    <Button
                      className="hover:bg-gray-700 lg:px-8 "
                      onClick={() => {
                        setopen(false);
                      }}
                      variant={"secondary"}
                    ...
                    <Button
                      ...
                      disabled={albumName === "" ? true : adding ? true : false}
                      onClick={add_to_album}
                      type="submit"
                    >
                      {!adding && (
                        <svg
            ...
            <DropdownMenuItem asChild className="text-sm ">
              ...
              >
                <Link
                  className="flex justify-start py-2 px-3 text-xs gap-2 w-full h-full"
                  href={`edit?public_id=${props.public_id}`}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
            ...
            <DropdownMenuItem asChild className="text-sm ">
              <Dialog open={del} onOpenChange={setdel}>
                <DialogTrigger asChild className="w-full h-full ">
                  <Button
                    className="w-full h-full py-2 px-3 text-xs flex justify-start gap-2"
                    type="button"
                    variant="destructive"
                  >
                    <svg
