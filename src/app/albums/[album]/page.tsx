  ...
  return (
    <>
      <div
        ...
        } my-5 mx-6 relative bg-gray-00 h-full `}
      >
        ...
        <div className="flex justify-between items-center">
          <Button
            ...
            variant="ghost"
            className="flex h-11 sm:h-12 text-base sm:text-lg gap-1 border-2 sm:gap-2 rounded-xl z-10 cursor-pointer hover:border-gray-200 border-gray-500 w-max px-3 mt-5 items-center "
          >
            <svg
          ...
          <Dialog open={del} onOpenChange={setdel}>
            <DialogTrigger asChild className="w-max h-11 sm:h-12">
              <Button
                ...
                variant="destructive"
                className="h-11 sm:h-12 flex sm:text-left gap-1 sm:gap-2 text-base border-2 rounded-xl cursor-pointer hover:border-gray-200 border-gray-500 w-max px-3 mt-5 items-center"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
            ...
            <DialogContent
              className={`${
                theme.dark_theme ? "dark text-white" : ""
              } sm:max-w-[425px]`}
            >
              <DialogHeader>
              ...
              <DialogFooter>
                <Button
                  className="hover:bg-gray-700 lg:px-5 "
                  onClick={() => {
                    setdel(false);
                  }}
                  variant={"secondary"}
