...
{!loading && folders.length===0  && <div className="bg-transparent translate-x-[-50%] translate-y-[-50%] absolute top-[40%] left-[50%]  w-full text-center sm:text-4xl text-3xl font-bold ">
            No Albums Created!
